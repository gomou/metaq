/*
 * $Id: Utility.cpp 15 2011-08-26 06:40:13Z  $
 */
#include "Utility.h"
#include "Buffer.h"
#include <cstdio>
...
namespace LWPR
{
	...
	UINT64 Utility::GetCurrentTimeMillis()
	{
		TIME_PRECISION_T now = GetTimePrecision();

		UINT64 second = now.nSeconds;
		UINT64 usecond = now.nUSeconds;

		return second << 6 + usecond;
	}
