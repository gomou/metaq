...
namespace LWPR
{
	...
	{
		SOCKET_RET_CONNECT_FAILED = -2,		// Socket连接，Connect
	...
	{
		SOCKET_INVOKE_OK,//RPC: 调用成功
		SOCKET_INVOKE_CONNECT_FAILED, //RPC: 网络连接失败
		SOCKET_INVOKE_SEND_DATA_FAILED,//RPC: 发送数据失败
		SOCKET_INVOKE_SEND_DATA_TIMEOUT,//RPC: 发送数据超时
		SOCKET_INVOKE_RECEIVE_DATA_FAILED,//RPC: 接收数据失败
		SOCKET_INVOKE_RECEIVE_DATA_TIMEOUT,//RPC: 接收数据超时
		SOCKET_INVOKE_POST_PROCESSING_FAILED,//RPC: 后期数据处理失败
	} SOCKET_INVOKE_RET_E;
	...
	public:
		...
		/**
		 * fromaddr=192.168.0.1，则toaddr=192.168.0.1
		 * fromaddr=www.sina.com，则toaddr=192.168.0.1
		 */
